...
public final class ChunkPlanGuiScreen extends Screen {
    ...
    private void renderAdmin(GuiGraphicsExtractor g) {
        ...
        if (resetTarget != null && resetTarget.getValue().trim().isEmpty()) {
            g.text(font, Component.translatable("gui.chunkplan.reset_target_hint"),
        ...
        if (presetTarget != null && presetTarget.getValue().isEmpty()) {
            g.text(font, Component.translatable("gui.chunkplan.preset_target_hint"),
        ...
        if (tiersDirty()) {
            g.text(font, Component.translatable("gui.chunkplan.preset_gate_hint"), x + 240, gy + 230, COL_YELLOW);
        }
    }
